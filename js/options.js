$(document).on('ready', function (e) {
  ...
  if (console && console.log) console.log('ready window');
  ...
  chrome.storage.sync.get({
    ...
    if (console && console.log) console.log('chrome.storage.sync.get', items);
  ...
  $('#save').on('click', function (e) {
    chrome.storage.sync.set({
      ...
      if (console && console.log) console.log('Saved');
    });
  });
